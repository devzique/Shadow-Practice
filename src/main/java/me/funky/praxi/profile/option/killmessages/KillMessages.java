...
public enum KillMessages {
    ...
    NERD("Nerd", Material.BOOK, "shadow.killmessages.nerd", new KillMessageCallable(){
    ...
    GAMER("Gamer", Material.DIAMOND_SWORD, "shadow.killmessages.gamer", new KillMessageCallable(){
	...
	RICKROLL("Rickroll", Material.REDSTONE, "shadow.killmessages.rickroll", new KillMessageCallable(){
    ...
    MEMES("Memes", Material.JUKEBOX, "shadow.killmessages.memes", new KillMessageCallable(){
