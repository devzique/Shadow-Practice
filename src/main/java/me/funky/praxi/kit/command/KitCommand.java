...
public class KitCommand extends BaseCommand {
    ...
    public void info(Player player, String kitName) {
        ...
        if (kit == null) return;
           ...
           player.sendMessage("");
           player.sendMessage(CC.translate(" &7▪ &fName: &b" + kitName));
           ...
           player.sendMessage(CC.translate(" &7▪ &fKnockback Profile: &b" + (kit.getKnockbackProfile()))); // TODO: Make this show Default if the kit doesnt have kb profile
