...
public class PartyManageMenu extends Menu {
    //re opening the inventory to update atm but need to change
    {
    ...
    private static class PartySizeButton extends Button {
        ...
        public ItemStack getButtonItem(Player player) {
			...
			} else if (player.hasPermission("practice.donator")) {
        ...
        public void clicked(Player player, ClickType clickType) {
            ...
            if (clickType == ClickType.LEFT) {
                if (profile.getParty().getLimit() < 100) {
                    ...
                    player.sendMessage(CC.translate("&bThe maximum players Limit Is 100"));
                }
                ...
                if (profile.getParty().getLimit() > 1) {
                    ...
                    player.sendMessage(CC.translate("&bThe minimum players Limit Is 1"));
                }
            }
        }
    }
