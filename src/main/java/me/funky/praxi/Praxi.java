...
import xyz.versedev.loader.VerseLoader;
...
import me.funky.praxi.adapter.tab.TablistAdapter;
...
import me.funky.praxi.commands.user.match.BotCommand;
...
import me.funky.praxi.bots.BotListener;
...
public class Praxi extends JavaPlugin {
	...
	@Getter private BasicConfigurationFile mainConfig, settingsConfig, arenasConfig, kitsConfig, eventsConfig, hotbarConfig, scoreboardConfig, tablistConfig, menusConfig, divisionsConfig, hologramConfig, databaseConfig;
	...
	public void onEnable() {
        ...
        // Tablist Load 
		if (this.getTablistConfig().getBoolean("tablist.enable")) {
			new Tab(this, new TablistAdapter(this));
		}
        ...
        sendMessage(CC.translate("&b  _________.__                .___             "));
        sendMessage(CC.translate("&b /   _____/|  |__ _____     __| _/______  _  __"));
        sendMessage(CC.translate("&b \\_____  \\ |  |  \\__  \\   / __ |/  _ \\ \\/ \\/ /"));
        sendMessage(CC.translate("&b /        \\|   Y  \\/ __ \\_/ /_/ (  <_> )     / "));
        sendMessage(CC.translate("&b/_______  /|___|  (____  /\\____ |\\____/ \\/\\_/  "));
        sendMessage(CC.translate("&b        \\/      \\/     \\/      \\/              "));
        ...
        sendMessage(CC.translate("&7> &fLicense: &bnull"));
        sendMessage(CC.translate("&7> &fCore: &b" + CoreManager.getInstance().getCoreSystem()));
