...
public class BasicFreeForAllMatch extends Match {
	...
	public void setupPlayer(Player player) {
		...
		if (getKit().getGameRules().isSumo() || getKit().getGameRules().isBedfight() || getKit().getGameRules().isBridge() || getKit().getGameRules().isEggwars() || getKit().getGameRules().isStickFight()) {
